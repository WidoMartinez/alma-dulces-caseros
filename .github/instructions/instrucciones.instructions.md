...
siempre mantener el sistema de notificaciones por correo electronico basado en phpmailer y el backend de pagos y demas en render.com 
...
sugiere hacer commits cuando hayan cambios pendientes de ser comiteados y sea necesario hacer un commit para continuar trabajando
notificar cuando se realicen cambios en los archivos .php ya que estos estan alojados en hostinger
...
Permitir que las pruebas funcionen desde el localhost y desde el servidor de hostinger en todos los casos
recorda que soy free en render.com por lo tanto no tengo shell en el servidor de render
Procura leer logs de correcciones anteriores para no repetir errores
generar logs cuando se generen errores para no cometer los mismos errores
